...
#  Corey Goldberg - 2010
#
#  linux_net_bandwidth_rrd.py - local network bandwidth monitoring script for linux
#
...
#        example crontab entry using a 300 sec (5 min) interval:
#        */5 * * * * /home/corey/linux_net_bandwidth_rrd.py
#
...
def main():  
    ...
    rrd_ops('net_bps_in', rx_bits, 'COUNTER', '009900', localhost_name, 1000)
