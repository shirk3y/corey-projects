...
class RRD(object):
    ...
    def graph(self, mins):       
        ...
        cmd.append('COMMENT:\\s')
        cmd.append('COMMENT:\\s')
        cmd.append('GPRINT:' + ds_name + 'last:last %.0lf%S    ') 
        cmd.append('GPRINT:' + ds_name + 'avg:avg %.0lf%S    ')
        cmd.append('GPRINT:' + ds_name + 'min:min %.0lf%S    ')
        cmd.append('GPRINT:' + ds_name + 'max:max %.0lf%S    ')
        cmd.append('COMMENT:\\s')
        cmd.append('COMMENT:\\s')
